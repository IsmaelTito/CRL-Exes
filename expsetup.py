...
class Exes_ExpSetup(object):
    ...
    def __init__(self, n=1, rounds=50, payoff="high", contextual=False, debug=False):
        ...
        self.epucks = [CRL_Epuck(position=positions[i], angle=angles[i], nother=2, nrewsensors=4) for i in range(n)]
